      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8 relative z-10">
        <ScrollReveal>
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/5 bg-zinc-950/50 backdrop-blur-xl p-8 md:p-16 lg:p-24 shadow-2xl">
            ...
            <div className="absolute top-0 right-0 h-[500px] w-[500px] -translate-y-1/2 translate-x-1/3 rounded-full bg-purple-500/10 blur-[120px]" />
            <div className="absolute bottom-0 left-0 h-[500px] w-[500px] translate-y-1/2 -translate-x-1/3 rounded-full bg-pink-500/10 blur-[120px]" />
            ...
            <div className="relative text-center max-w-3xl mx-auto flex flex-col items-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-purple-500/20 bg-purple-500/10 px-4 py-2 text-sm font-medium text-purple-300 backdrop-blur-md">
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
                <Link
                  href="/contact"
                  className="group relative inline-flex h-14 w-full sm:w-auto items-center justify-center gap-2 overflow-hidden rounded-full bg-purple-600 px-8 text-base font-semibold text-white transition-all hover:bg-purple-700 hover:ring-4 hover:ring-purple-500/20"
                >
